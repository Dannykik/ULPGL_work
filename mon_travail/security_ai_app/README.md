...
La nouvelle app `surveillance_app.py` enregistre automatiquement :

- les événements (`camera_start`, `tracking_on`, `motion_detected`, etc.)
- les métadonnées d'enregistrement vidéo (nom fichier, durée, taille)
